...
$query=mysqli_query($con,"insert into userreport(noreport,fullname,IcNo,address,gender,treatment,medtype) values('$noreport','$fname','$icno','$address','$gender','$treatment','$medtype')");
if($query)
{
					...
					<form name="consultation" id="consultation"  method="post">
						<fieldset>
						    ...
						    <div class="form-group">
                               ...
                               <p> Saya mengesahkan bahawa pesakit tersebut seperti nama dan kad pengenalan diatas telah</p>
                               <p> mendapatkan rawatan di klinik saya.</p>

                             	<div class="form-group">
								Type of Treatment:<select name="specilization" class="form-control" onChange="getspecilization(this.value);" required="required">
																<option value=""></option>
...
?>
							...
							<div class="form-group">
								...
								<select name="productname" class="form-control" onChange="getproduct(this.value);" required="required">
																<option value="">Medicine 1</option>
<?php $ret=mysqli_query($con,"select * from products");
while($row=mysqli_fetch_array($ret))
{
?>
																<option value="<?php echo htmlentities($row['product_name']);?>">
