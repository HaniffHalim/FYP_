...
class PDF_reciept extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(0, 30, "Poliklinik An-Nisa' Cyberjaya", 0, 1, 'C', true);
    }
    ...
    function Footer() {
        ...
        $this->SetTextColor(0);
        $this->SetXY(0,-60);
        $this->Cell(0, 20, "Thank you & Have a nice day", 'T', 0, 'C');
    }
...
$pdf->Ln(30);
$pdf->Write(13, "nipbizzy@gmail.com", "mailto:m.haniffhalim@gmail.com");
