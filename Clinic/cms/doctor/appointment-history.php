...
if(isset($_GET['cancel']))
		  {
                  ...
                  $_SESSION['msg']="Appointment is Done!!";
		  }
?>
<!DOCTYPE html>
<html lang="en">
						...
						<section id="page-title">
							<div class="row">
								...
								<ol class="breadcrumb">
									...
									<li class="active">
										<span>Online Appointment History</span>
									</li>
								</ol>
							</div>
						</section>
...
$sql=mysqli_query($con,"select users.fullName as fname,appointment.* 
 from appointment join users on users.id=appointment.userId where appointment.doctorId='".$_SESSION['id']."'");
$cnt=1;
